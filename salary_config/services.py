...
from finance.models import SalaryPayment


def get_paid_amount(user, start_date, end_date):
...
class SalaryCalculationService:
    ...
    def calculate_installer_salary(
        ...
        paid = get_paid_amount(installer, start_date, end_date)


        remaining = total_salary - paid
    ...
    def calculate_manager_salary(
        ...
        paid = get_paid_amount(manager, start_date, end_date)
    ...
    def calculate_owner_salary(
        ...
        paid = get_paid_amount(owner_user, start_date, end_date)
